...
import image from "../../assets/images/whoarewe.png";
      ...
      <Grid container spacing={6} sx={{ padding: '50px', display: 'flex', maxWidth: '1300px', alignItems: 'center' }}>
        <Grid item xs={12} md={7}>
          ...
          <Typography variant="h6" style={{ opacity: '0.4', paddingBottom: '30px', }}>
            We are an one stop platform which connects  Farm startups  and investors.
            At Agriconnect, we offer investors a wide range of Agricultural projects that interests them
            while offering Startups with several options of investors.
          </Typography>
          <Button
            variant="contained"
            color="primary"
